...
% Parámetros
Ventana_MA_Mayor = 20; % Dias para calcular ventana de medias móviles con reacción lenta
Ventana_MA_Menor = 3; % Dias para calcular ventana de medias móviles con reacción rápida
numDatos = length(Datos_EURO); % Número de datos de precios
...
% Computar medias móviles lentas
...
% Computar medias móviles rápidas
...
% Generar señales de compra y venta cuando ambas medias moviles se cruzan 
...
% Inicializar vectores de señales por default HOLD [0]
signal_EURO = zeros(numDatos,1);
signal_DOW = zeros(numDatos,1);
signal_IBEX = zeros(numDatos,1);

% El tipo de señal de compra [1] o venta [-1] en el cruce lo da el signo
% de la pendiente de la media movil rápida en el punto de cruce
